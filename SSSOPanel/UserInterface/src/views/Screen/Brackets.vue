                        ...
                        <div class="lower">
                            ...
                            <div class="games">
                                <div class="game game-j">
                                    ...
                                    <template
                                        v-for="(player, i) in matches?.find((x) => x.identifier === 'J')?.players"
                                        :key="i"
                                    >
                                        <ScreenBracketUserKO :player="player" />
                                    </template>
                                ...
                                <div class="game game-k">
                                    ...
                                    <template
                                        v-for="(player, i) in matches?.find((x) => x.identifier === 'K')?.players"
                                        :key="i"
                                    >
                                        <ScreenBracketUserKO :player="player" />
                                    </template>
                        ...
                        <div class="lower">
                            ...
                            <div class="games">
                                <div class="game game-l">
                                    ...
                                    <template
                                        v-for="(player, i) in matches?.find((x) => x.identifier === 'L')?.players"
                                        :key="i"
                                    >
                                        <ScreenBracketUserKO :player="player" />
                                    </template>
                                ...
                                <div class="game game-m">
                                    ...
                                    <template
                                        v-for="(player, i) in matches?.find((x) => x.identifier === 'M')?.players"
                                        :key="i"
                                    >
                                        <ScreenBracketUserKO :player="player" />
                                    </template>
                        ...
                        <div class="lower">
                            ...
                            <div class="games">
                                <div class="game game-n">
                                    ...
                                    <template
                                        v-for="(player, i) in matches?.find((x) => x.identifier === 'N')?.players"
                                        :key="i"
                                    >
                                        <ScreenBracketUserKO :player="player" />
                                    </template>
                        ...
                        <div class="upper">
                            ...
                            <div class="games">
                                <div class="game game-h">
                                    ...
                                    <template
                                        v-for="(player, i) in matches?.find((x) => x.identifier === 'H')?.players"
                                        :key="i"
                                    >
                                        <ScreenBracketUserKO :player="player" />
                                    </template>
                        ...
                        <div class="lower">
                            ...
                            <div class="games">
                                <div class="game game-o">
                                    ...
                                    <template
                                        v-for="(player, i) in matches?.find((x) => x.identifier === 'O')?.players"
                                        :key="i"
                                    >
                                        <ScreenBracketUserKO :player="player" />
                                    </template>
                        ...
                        <div class="upper">
                            ...
                            <div class="games">
                                <div class="game game-i">
                                    ...
                                    <template
                                        v-for="(player, i) in matches?.find((x) => x.identifier === 'I')?.players"
                                        :key="i"
                                    >
                                        <ScreenBracketUserKO :player="player" />
                                    </template>
